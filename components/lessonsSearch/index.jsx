...
const LessonSearch = (props) => {
    ...
    return (
        <div className="w-[85rem]  bg-opacity-15 bg-[#1FAAEA] max-h-60 rounded-3xl flex flex-row m-12 drop-shadow-2xl" dir="rtl">
            <div className="basis-2/12 border-t-0 drop-shadow-xl p-6 ">
                <img className={'rounded-3xl backdrop-contrast-50 scale-105  h-40 w-48 ' } src='/images/why.jpg' alt={'why UniPoll ?'} /></div>
            <div className="basis-8/12 bg flex flex-row gap-12 justify-center items-center ">
