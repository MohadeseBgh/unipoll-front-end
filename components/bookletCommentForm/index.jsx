...
const BookletCommentForm = (props) => {
    ...
    const [formValue, setFormValue] = useState({text:"",bookletPublicId:"",termPublicId:"",unknown:false});
    useEffect(() => {
        setFormValue({...formValue, bookletPublicId: selectedBooklet.publicId})
    ...
    const formSubmitHandler = async (e) =>{
        ...
        try {
            ...
            const response = await fetch("http://Localhost:8090/unipoll/v1/comment-b", {
                method: "POST",
            ...
            <form className="flex flex-col text-black justify-between " dir='rtl' onSubmit={formSubmitHandler}>
                <div className='flex flex-row my-8 '>
                    <div className='basis-3/4'>
                        <h3 className='text-xl  mr-2'>با ارسال دیدگاه خود در مورد این جزوه به دانشجویان دیگر درانتخاب
                             جزوه کمک کنید.</h3>
                    </div>
                ...
                <textarea id="commentText" maxLength='500' className="block h-56 w-full p-4 ps-10  text-black-900 rounded-3xl  bg-[#DFE8EF] text-lg placeholder:text-[#8B8C8D]
                          ...
                          placeholder="دیدگاه خود را برای این جزوه بنویسید...." required onChange={(event) => {
...
export default BookletCommentForm;