...
const Home = () => {
    const [topBooklet, setTopBooklet] = useState([{courseName:"مبانی برنامه نویسی" ,professorName:"رضا رمضانی",semesterInfo:"پاییز 1400" ,like:20},
        ...
        {courseName:"مبانی برنامه نویسی" ,professorName:"رضا رمضانی",semesterInfo:"پاییز 1400" ,like:320}]);
  return(
      <div className='h-screen w-screen flex flex-col bg-white gap-y-10 overflow-x-hidden'>
          ...
          <div id="searchBar "
               className="   flex flex-col items-center justify-items-center min-h-[35rem] laptop:w-screen mobile:w-auto"
               dir="rtl">
              <div
                  ...
                  <form className='laptop:px-24 mobile:px-3 laptop:flex-row mobile:flex flex-col items-center justify-items-center'>
                      <div
          ...
          <div id="whyUniPoll" className=' w-screen text-black laptop:flex-row  mobile: flex flex-col items-center'>
          ...
          <div id="educationalGroups " className=" w-screen flex flex-col items-center justify-center ">
              <h3 className='laptop:text-5xl tablet:text-[2rem]  font-bold text-black items-center '>گروه های آموزشی
                  دانشکده</h3>
              <div className=' grid gap-12  laptop:grid-cols-4  tablet:grid-cols-2 mobile:grid-cols-1items-center my-24  '>
